 ...
 * between measurement objects (descriptions, tasks, and results, etc.) and
 * JSON objects. New types of MeasurementDesc should be registered in the static
 * HashMap initialization section.
 */
